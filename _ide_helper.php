 ...
 * Generated for Laravel 5.8.29 on 2019-07-18 15:14:32.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Notification {
        ...
        /**
         * Assert the total quantity of times a notification was sent.
         *
    ...
    class Session {
         ...
         * @static
         */
        public static function increment($key, $quantity = 1)
        {
                        /** @var \Illuminate\Session\Store $instance */
                        return $instance->increment($key, $quantity);
        }
         ...
         * @static
         */
        public static function decrement($key, $quantity = 1)
        {
                        /** @var \Illuminate\Session\Store $instance */
                        return $instance->decrement($key, $quantity);
        }
