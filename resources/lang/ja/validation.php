...
return [
    ...
    */
    ...
    'lt' => [
        ...
        'string' => ':attributeには:value文字より少ない文字数で指定してください。',
        'array' => ':attributeには:value個より少なくの要素を持つ配列を指定してください。',
    ],
    'lte' => [
        'numeric' => ':attributeには:value以下の数値を指定してください。',
        'file' => ':attributeには:value KB以下のファイルを指定してください。',
        'string' => ':attributeには:value文字以下の文字数で指定してください。',
    ...
    'starts_with' => ':attributeは:valuesから始まる必要があります。',
